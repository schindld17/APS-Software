...
void CMPSSInit(void)
{
	...
	Cmpss6Regs.COMPCTL.bit.COMPHINV = 0x1;
#ifdef _NO_VOLT_TEST
	//Set DAC to midpoint for reference
	Cmpss6Regs.DACHVALS.bit.DACVAL = 2048;
#else
	//Set DAC to midpoint for reference
	Cmpss6Regs.DACHVALS.bit.DACVAL = CMPSS_SOL_H;
#endif
	...
	Cmpss6Regs.COMPCTL.bit.COMPLINV = 0x0;
#ifdef _NO_VOLT_TEST
	//Set DAC to midpoint for reference
	Cmpss6Regs.DACLVALS.bit.DACVAL = 100;
#else
	//Set DAC to midpoint for reference
	Cmpss6Regs.DACLVALS.bit.DACVAL = CMPSS_SOL_L;
#endif
	//Asynch output feeds for CTRIPH and CTRIPOUTH
	Cmpss6Regs.COMPCTL.bit.CTRIPLSEL = 0x0;
	...
	Cmpss8Regs.COMPCTL.bit.COMPHINV = 0x1;
#ifndef _NO_VOLT_TEST
	//Set DAC to midpoint for reference
	...
	Cmpss1Regs.COMPCTL.bit.COMPHINV = 0x1;
#ifndef _NO_VOLT_TEST
	//Set DAC to midpoint for reference
	Cmpss1Regs.DACHVALS.bit.DACVAL = 2048;
#else
	//Set DAC to midpoint for reference
	Cmpss1Regs.DACHVALS.bit.DACVAL = CMPSS_CAP_H;
#endif
	//Asynch output feeds for CTRIPH
	...
	Cmpss1Regs.COMPCTL.bit.COMPLINV = 0x0;
#ifdef _NO_VOLT_TEST
	//Set DAC to midpoint for reference
	Cmpss1Regs.DACLVALS.bit.DACVAL = 100;
#else
	//Set DAC to midpoint for reference
	Cmpss1Regs.DACLVALS.bit.DACVAL = CMPSS_CAP_L;
#endif
	//Asynch output feeds for CTRIPH and CTRIPOUTH
	Cmpss8Regs.COMPCTL.bit.CTRIPLSEL = 0x0;
...
void EPWMInit(void)
{
	...
	//Configure DCAEVNT1 to be Trip 1
	EPwm2Regs.DCTRIPSEL.bit.DCAHCOMPSEL = 0x0;
	//Configure DCAEVNT2 to be Trip 2
